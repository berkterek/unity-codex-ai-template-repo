---
name: unity-graphics-setup
description: "Use when the user asks to run the repository unity command graphics-setup, /graphics-setup, or the /graphics-setup — URP Platform Graphics Setup workflow."
---
...
`.codex/packs/unity-game/commands/graphics-setup.md`
