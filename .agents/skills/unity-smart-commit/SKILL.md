---
name: unity-smart-commit
description: "Use when the user asks to run the repository unity command smart-commit, /smart-commit, or the Smart Commit — Analyze Changes and Commit Intelligently workflow."
---
...
`.codex/packs/unity-game/commands/smart-commit.md`
