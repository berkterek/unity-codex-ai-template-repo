---
name: unity-update-scene-hierarchy
description: "Use when the user asks to run the repository unity command update-scene-hierarchy, /update-scene-hierarchy, or the /update-scene-hierarchy — Scene Hierarchy Organizer workflow."
---
...
`.codex/packs/unity-game/commands/update-scene-hierarchy.md`
