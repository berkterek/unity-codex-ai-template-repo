---
name: unity-update-plan
description: "Use when the user asks to run the repository unity command update-plan, /update-plan, or the Update Plan — Analyze → Revise → Review → Save Pipeline workflow."
---
...
`.codex/packs/unity-game/commands/update-plan.md`
