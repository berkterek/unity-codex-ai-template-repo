---
name: unity-implement-lite
description: "Use when the user asks to run the repository unity command implement-lite, /implement-lite, or the Implement Lite — Lightweight Single-Class Implementation workflow."
---
...
`.codex/packs/unity-game/commands/implement-lite.md`
