---
name: unity-search
description: "Use when the user asks to run the repository unity command search, /search, or the /search — Research → Review → Present Pipeline workflow."
---
...
`.codex/packs/unity-game/commands/search.md`
