---
name: unity-silent-failure-hunter
description: "Use when the user asks to run the repository unity command silent-failure-hunter, /silent-failure-hunter, or the Silent Failure Hunter — Unity Error Resilience Audit workflow."
---
...
`.codex/packs/unity-game/commands/silent-failure-hunter.md`
