---
name: unity-migrate
description: "Use when the user asks to run the repository unity command migrate, /migrate, or the /migrate — Migrator → Reviewer → Committer Pipeline workflow."
---
...
`.codex/packs/unity-game/commands/migrate.md`
