---
name: unity-discover
description: "Use when the user asks to run the repository unity command discover, /discover, or the discover workflow."
---
...
`.codex/packs/unity-game/commands/discover.md`
