---
name: unity-update-rules
description: "Use when the user asks to run the repository unity command update-rules, /update-rules, or the /update-rules — Project Rules Sync Agent workflow."
---
...
`.codex/packs/unity-game/commands/update-rules.md`
