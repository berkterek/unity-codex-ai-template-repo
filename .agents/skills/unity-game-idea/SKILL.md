---
name: unity-game-idea
description: "Use when the user asks to run the repository unity command game-idea, /game-idea, or the Game Idea Refiner — GDD Creator Agent workflow."
---
...
`.codex/packs/unity-game/commands/game-idea.md`
