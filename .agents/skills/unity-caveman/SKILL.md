---
name: unity-caveman
description: "Use when the user asks to run the repository unity command caveman, /caveman, or the Caveman — Ultra-Compressed Communication Mode workflow."
---
...
`.codex/packs/unity-game/commands/caveman.md`
