---
name: unity-migrator
description: "Use when the user asks to run the repository unity command migrator, /migrator, or the Migrator Agent — Legacy Pattern Modernizer workflow."
---
...
`.codex/packs/unity-game/commands/migrator.md`
