---
name: unity-refine-gdd
description: "Use when the user asks to run the repository unity command refine-gdd, /refine-gdd, or the Refine GDD — Game Design Document Iteration workflow."
---
...
`.codex/packs/unity-game/commands/refine-gdd.md`
