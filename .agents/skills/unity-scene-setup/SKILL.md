...
description: "Use when the user asks to run the repository unity command scene-setup, /scene-setup, or the Scene Setup — C# Scripts + Unity Editor Wiring Pipeline workflow."
---
...
`.codex/packs/unity-game/commands/scene-setup.md`
