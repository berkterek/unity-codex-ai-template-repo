---
name: unity-adr
description: "Use when the user asks to run the repository unity command adr, /adr, or the /adr — Architecture Decision Record workflow."
---
...
`.codex/packs/unity-game/commands/adr.md`
