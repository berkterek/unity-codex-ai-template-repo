---
name: unity-smart-commit-selected
description: "Use when the user asks to run the repository unity command smart-commit-selected, /smart-commit-selected, or the Smart Commit Selected — Plan, Select & Commit workflow."
---
...
`.codex/packs/unity-game/commands/smart-commit-selected.md`
