---
name: unity-debugger
description: "Use when the user asks to run the repository unity command debugger, /debugger, or the Debugger Agent — Root Cause Analysis Specialist workflow."
---
...
`.codex/packs/unity-game/commands/debugger.md`
