---
name: unity-create-test
description: "Use when the user asks to run the repository unity command create-test, /create-test, or the /create-test — Unified Test Generator workflow."
---
...
`.codex/packs/unity-game/commands/create-test.md`
