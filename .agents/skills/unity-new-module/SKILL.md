---
name: unity-new-module
description: "Use when the user asks to run the repository unity command new-module, /new-module, or the New Module — 5-File Module Generator workflow."
---
...
`.codex/packs/unity-game/commands/new-module.md`
