---
name: unity-check-portability
description: "Use when the user asks to run the repository unity command check-portability, /check-portability, or the Check Portability — Module Portability Audit workflow."
---
...
`.codex/packs/unity-game/commands/check-portability.md`
