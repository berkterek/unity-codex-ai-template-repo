---
name: unity-setup-project
description: "Use when the user asks to run the repository unity command setup-project, /setup-project, or the Setup Project — New Unity Project Initializer workflow."
---
...
`.codex/packs/unity-game/commands/setup-project.md`
