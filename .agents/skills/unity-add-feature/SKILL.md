---
name: unity-add-feature
description: "Use when the user asks to run the repository unity command add-feature, /add-feature, or the Add Feature — Incremental Pipeline Update workflow."
---
...
`.codex/packs/unity-game/commands/add-feature.md`
