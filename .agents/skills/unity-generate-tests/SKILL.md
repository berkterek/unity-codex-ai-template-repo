---
name: unity-generate-tests
description: "Use when the user asks to run the repository unity command generate-tests, /generate-tests, or the Generate Tests — Missing Test Writer workflow."
---
...
`.codex/packs/unity-game/commands/generate-tests.md`
