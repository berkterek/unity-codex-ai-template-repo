---
name: unity-mermaid
description: "Use when the user asks to run the repository unity command mermaid, /mermaid, or the Mermaid — Architecture Diagram Generator workflow."
---
...
`.codex/packs/unity-game/commands/mermaid.md`
