---
name: unity-build-knowledge-graph
description: "Use when the user asks to run the repository unity command build-knowledge-graph, /build-knowledge-graph, or the /build-knowledge-graph — Unity Knowledge Graph Builder workflow."
---
...
`.codex/packs/unity-game/commands/build-knowledge-graph.md`
