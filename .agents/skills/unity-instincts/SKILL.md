...
description: "Use when the user asks to run the repository unity command instincts, /instincts, or the /unity-instincts — Instinct Library workflow."
---
...
`.codex/packs/unity-game/commands/instincts.md`
