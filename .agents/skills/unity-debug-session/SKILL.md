...
description: "Use when the user asks to run the repository unity command debug-session, /debug-session, or the Debug Session — Structured Bug Investigation workflow."
---
...
`.codex/packs/unity-game/commands/debug-session.md`
