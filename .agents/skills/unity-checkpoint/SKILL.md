---
name: unity-checkpoint
description: "Use when the user asks to run the repository unity command checkpoint, /checkpoint, or the Checkpoint — Context Save & Clear workflow."
---
...
`.codex/packs/unity-game/commands/checkpoint.md`
