...
description: "Use when the user asks to run the repository unity command performance-audit, /performance-audit, or the Performance Audit — Hot Path and Allocation Checker workflow."
---
...
`.codex/packs/unity-game/commands/performance-audit.md`
