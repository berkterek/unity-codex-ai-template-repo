---
name: unity-unity-scene-update
description: "Use when the user asks to run the repository unity command unity-scene-update, /unity-scene-update, or the /unity-scene-update — Full Scene Audit & Fix workflow."
---
...
`.codex/packs/unity-game/commands/unity-scene-update.md`
