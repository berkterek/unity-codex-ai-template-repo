---
name: unity-context-prime
description: "Use when the user asks to run the repository unity command context-prime, /context-prime, or the Context Prime workflow."
---
...
`.codex/packs/unity-game/commands/context-prime.md`
