...
description: "Use when the user asks to run the repository unity command knowledge-graph, /knowledge-graph, or the /knowledge-graph — Query the Unity Knowledge Graph workflow."
---
...
`.codex/packs/unity-game/commands/knowledge-graph.md`
