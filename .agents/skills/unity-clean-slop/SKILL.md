---
name: unity-clean-slop
description: "Use when the user asks to run the repository unity command clean-slop, /clean-slop, or the Clean Slop — Post-Implementation Code Quality Sweep workflow."
---
...
`.codex/packs/unity-game/commands/clean-slop.md`
