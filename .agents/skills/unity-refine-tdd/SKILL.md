---
name: unity-refine-tdd
description: "Use when the user asks to run the repository unity command refine-tdd, /refine-tdd, or the Refine TDD — Technical Design Document Iteration workflow."
---
...
`.codex/packs/unity-game/commands/refine-tdd.md`
