...
description: "Use when the user asks to run the repository unity command architect, /architect, or the Technical Architect Agent — TDD Creator workflow."
---
...
`.codex/packs/unity-game/commands/architect.md`
