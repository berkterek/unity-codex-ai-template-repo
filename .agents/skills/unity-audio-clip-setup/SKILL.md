---
name: unity-audio-clip-setup
description: "Use when the user asks to run the repository unity command audio-clip-setup, /audio-clip-setup, or the /audio-clip-setup — AudioClip Import Settings Optimizer workflow."
---
...
`.codex/packs/unity-game/commands/audio-clip-setup.md`
