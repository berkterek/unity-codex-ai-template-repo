---
name: unity-five
description: "Use when the user asks to run the repository unity command five, /five, or the Five Whys — Root Cause Analysis workflow."
---
...
`.codex/packs/unity-game/commands/five.md`
