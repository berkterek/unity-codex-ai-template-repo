---
name: unity-dump
description: "Use when the user asks to run the repository unity command dump, /dump, or the Dump — Context Export workflow."
---
...
`.codex/packs/unity-game/commands/dump.md`
