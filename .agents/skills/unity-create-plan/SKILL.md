---
name: unity-create-plan
description: "Use when the user asks to run the repository unity command create-plan, /create-plan, or the Create Plan — Research → Plan → Review → Save Pipeline workflow."
---
...
`.codex/packs/unity-game/commands/create-plan.md`
