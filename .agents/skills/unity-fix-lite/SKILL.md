---
name: unity-fix-lite
description: "Use when the user asks to run the repository unity command fix-lite, /fix-lite, or the Fix Lite — Lightweight Single-File Fix workflow."
---
...
`.codex/packs/unity-game/commands/fix-lite.md`
