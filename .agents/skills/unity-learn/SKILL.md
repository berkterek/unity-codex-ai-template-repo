---
name: unity-learn
description: "Use when the user asks to run the repository unity command learn, /learn, or the Learn — Pattern Extraction from Completed Work workflow."
---
...
`.codex/packs/unity-game/commands/learn.md`
