---
name: unity-fix-deep
description: "Use when the user asks to run the repository unity command fix-deep, /fix-deep, or the /fix-deep — Evidence-First Bug Fix Pipeline workflow."
---
...
`.codex/packs/unity-game/commands/fix-deep.md`
