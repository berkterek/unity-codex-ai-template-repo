...
description: "Use when the user asks to run the repository unity command update-claude-md, /update-claude-md, or the Update AGENTS.md — Project Config Sync workflow."
---
