...
description: "Use when the user asks to run the repository core command orchestrate, /orchestrate, or the Orchestrate workflow."
---
...
`.codex/core/commands/orchestrate.md`
