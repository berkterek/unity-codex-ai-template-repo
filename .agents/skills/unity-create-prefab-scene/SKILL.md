---
name: unity-create-prefab-scene
description: "Use when the user asks to run the repository unity command create-prefab-scene, /create-prefab-scene, or the /create-prefab-scene — Legacy Scene Migration → Prefab Inventory → Prefab Creation → Review → Commit workflow."
---
...
`.codex/packs/unity-game/commands/create-prefab-scene.md`
