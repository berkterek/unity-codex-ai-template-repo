...
Builds UI screens with both code and visual setup via MCP. Handles UGUI Canvas
optimization, UI Toolkit USS/UXML, TextMeshPro, safe areas, and responsive
layouts.
...
- `.codex/packs/unity-game/skills/systems/ui-toolkit/SKILL.md`
...
- **Disable Raycast Target** on all elements that don't need interaction.
...
- Never use legacy `UnityEngine.UI.Text` — always use `TextMeshProUGUI`.
