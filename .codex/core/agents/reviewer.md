...
> Unity reviewer with compilation verification, runtime validation,
...
All code review uses the configured reviewer agent — never auto-approve or skip
the review step.
...
- Data/state transitions are coherent.
...
Run or inspect the verification commands from `.codex/project/TOOLING.md`.
